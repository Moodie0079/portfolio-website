  ...
  return `
    <nav class="bg-white/80 backdrop-blur-md fixed top-0 left-0 right-0 z-50 shadow-sm border-b border-gray-200">
      <div class="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
        <a href="${isHomePage ? '#' : 'index.html'}" id="scrollToTop" class="text-xl sm:text-2xl font-bold text-gray-900 min-w-0 hover:text-blue-600 transition cursor-pointer">Mahmoud</a>
        ...
        <div class="hidden lg:flex items-center gap-4">
          ...
          <a href="https://www.linkedin.com/in/-mahmoudshalabi/" target="_blank" class="p-2 rounded-lg hover:bg-gray-100 transition" aria-label="LinkedIn">
      ...
      <div id="mobileMenu" class="lg:hidden hidden bg-white/80 backdrop-blur-md border-t border-gray-200">
        <div class="px-4 py-6 space-y-3">
          <a href="${isHomePage ? '#projects' : 'index.html#projects'}" class="block py-2 hover:text-blue-600 transition mobile-nav-link text-gray-700">Projects</a>
          <a href="${isHomePage ? '#education' : 'index.html#education'}" class="block py-2 hover:text-blue-600 transition mobile-nav-link text-gray-700">Education</a>
          <a href="${isHomePage ? '#skills' : 'index.html#skills'}" class="block py-2 hover:text-blue-600 transition mobile-nav-link text-gray-700">Skills</a>
          <a href="${isHomePage ? '#contact' : 'index.html#contact'}" class="block py-2 hover:text-blue-600 transition mobile-nav-link text-gray-700">Contact</a>
          <div class="flex gap-4 pt-4 border-t border-gray-200">
            ...
            <a href="https://www.linkedin.com/in/-mahmoudshalabi/" target="_blank" class="p-2 rounded-lg hover:bg-gray-100 transition">
              <svg class="w-5 h-5 text-gray-700" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd" d="M16.338 16.338H13.67V12.16c0-.995-.017-2.277-1.387-2.277-1.39 0-1.601 1.086-1.601 2.207v4.248H8.014v-8.59h2.559v1.174h.037c.356-.675 1.227-1.387 2.526-1.387 2.703 0 3.203 1.778 3.203 4.092v4.711zM5.005 6.575a1.548 1.548 0 11-.003-3.096 1.548 1.548 0 01.003 3.096zm-1.337 9.763H6.34v-8.59H3.667v8.59zM17.668 1H2.328C1.595 1 1 1.581 1 2.298v15.403C1 18.418 1.595 19 2.328 19h15.34c.734 0 1.332-.582 1.332-1.299V2.298C19 1.581 18.402 1 17.668 1z" clip-rule="evenodd"></path>
              </svg>
            </a>
